...
## Milestone 2: 에이전트 코어 파이프라인 및 백엔드 기반 구축 (2026-10-16 ~ 2026-11-30)
- **달성 목표**:
...
## Milestone 3: 역산(Backtracking) 로드맵 엔진 및 웹 프로토타입 (2026-12-01 ~ 2027-01-15)
- **달성 목표**:
...
## Milestone 4: 적응형 재계획(Re-planning) 엔진 및 웹 연동 (2027-01-16 ~ 2027-02-28)
- **달성 목표**:
